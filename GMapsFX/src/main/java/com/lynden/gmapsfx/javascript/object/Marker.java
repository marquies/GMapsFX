...
public class Marker extends JavascriptObject {
	 ...
	 * 
	 * @param markerOptions
	 *            The options to use when constructing this marker.
	 */
	...
	/**
	 * This method is called from the GoogleMap.addMarker() method, it should
	 * not be invoked directly.
	 *
	 * @param map
	 *            The map to add this Marker to.
	 */
	 ...
	 * 
	 * @param animation
	 *            The animation to use for this marker.
	 */
	...
	public boolean getDraggable() {
		return invokeJavascriptReturnValue("getDraggable", Boolean.class);
	}
